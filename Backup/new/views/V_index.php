							...
							<div id="login-box" class="login-box visible widget-box no-border">
								<div class="widget-body">
									<div class="widget-main">
										...
										<form id="form_login" name="form_login" action="<?php echo base_url('C_index/login_check'); ?>" method="post">
											<fieldset>
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="text" id="si_userid" name="si_userid" class="form-control" placeholder="Userid" required/>
												...
												<div class="clearfix">
													<button type="submit" id="btn_login" name="btn_login" class="width-35 pull-right btn btn-sm btn-primary">
