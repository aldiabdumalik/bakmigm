					...
					?>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
							...
							<div class="form-group">
								<object data="<?=$url_path_persetujuan;?>" type="application/pdf" width="535px" height="535px">
										...
										<div class="widget-main padding-8">
											...
											<div id="profile-feed-1" class="profile-feed">
												<?php
													$si_key = $this->input->post('si_key');
													$si_key = $si_key[0];
													$get_data_comment = $this->M_library_database->DB_GET_DATA_DOCUMENT_COMMENT_BY_AUTHOR($SESSION_ID,$si_key);
													if(empty($get_data_comment)||$get_data_comment==""){
														//DO NOTHING
													}else{
														foreach($get_data_comment as $data_row){
												?>
														<div class="profile-activity clearfix">
															<div>
																<img class="pull-left" src="<?php echo base_url('template/backend/assets/images/avatars/avatar2.png'); ?>" />
																<a class="user"> <?php echo $data_row->DTCT_USER; ?> </a>
																<div>
																	<p>
																		<table width="100%">
																			<tr>
																...
																<div class="time">
																	...
																	<?php echo date('m/d/Y G:i', strtotime($data_row->DTCT_DATE)); ?> WIB
																</div>
															</div>
														</div>
												<?php
