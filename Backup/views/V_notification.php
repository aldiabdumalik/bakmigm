		...
		<div class="page-content">
			...
			<div class="row">
				...
				if($is_continue){
								...
								<div class="alert alert-block alert-danger">
									<p>
										<strong>
											...
											Halo <?php echo $SESSION_ID; ?>!
										</strong>
									</p>
									<p>
										<?php echo date('d/m/Y G:i', strtotime($data_row_ext->DOC_DATE));?> WIB, <?php echo $data_row_ext->DOC_MAKER; ?> Melakukan Registrasi eDocument, Status : <?php echo $data_row_ext->DOC_STATUS; ?>, Dokumen : <?php echo $data_row_ext->DOC_NAMA; ?>. Mohon untuk di verifikasi.
									</p>
									<p>
										<?php
										$FILTER_DOC_STATUS = $data_row_ext->DOC_STATUS;
										if($FILTER_DOC_STATUS == "WAITING PENDISTRIBUSI" && $SESSION_ROLES=="PENDISTRIBUSI"){
											?>
											<table>
												<tr>
													<th>
											...
											<?php
										}else if($FILTER_DOC_STATUS == "WAITING ATASAN PENCIPTA" && $SESSION_ROLES=="ATASAN PENCIPTA"){
											?>
											<table>
												<tr>
													<th>
					...
					}else if($SESSION_ROLES=="PENCIPTA"){
						foreach($get_data_ext as $data_row_ext){
							$status_document = $data_row_ext->DOC_STATUS;
							if(strpos($status_document, "REJECT") !== false){
								?>
								<div class="col-12">
									<div class="alert alert-block alert-warning">
										...
										<p>
											Dokumen : <?php echo $data_row_ext->DOC_NAMA; ?>, Status : <?php echo $data_row_ext->DOC_STATUS; ?>. Mohon untuk segera di update.
										</p>
										...
										foreach($get_data_info_reject as $data_row_info_reject){
											?>
											<b>
												<?php echo $index_info_reject; ?>. <?php echo date('d/m/Y G:s', strtotime($data_row_info_reject->DTDLSS_DATE)); ?> WIB, Oleh : <?php echo $data_row_info_reject->DTDLSS_MAKER; ?>, Note : <?php echo $data_row_info_reject->DTDLSS_NOTE; ?><br />
											</b>
											<?php
											$index_info_reject++;
										}
								...
								<div class="col-12">
									<div class="alert alert-block alert-info">
										...
										<p>
											<?php echo date('d/m/Y G:i', strtotime($data_row_ext->DOC_DATE));?> WIB, Dokumen : <?php echo $data_row_ext->DOC_NAMA; ?>, Status : <?php echo $data_row_ext->DOC_STATUS; ?>.
										</p>
									</div>
								</div>
								<?php
				...
				if($is_continue):
					if($SESSION_ROLES=="PENCIPTA"):
						foreach($get_data_ext as $data_row_ext):
							...
							if($tgl_final <= 90 && $tgl_final >= 1 && $data_row_ext->DOC_STATUS =="PUBLISH"): 
								?>
								<div class="col-12">
									<div class="alert alert-block alert-warning">
										<p>Halo <?php echo $SESSION_ID; ?>!</p>
										<div class="row">
											<div class="col-sm-10">
												<p>
													Dokumen <?=$data_row_ext->DOC_NAMA; ?>, Akan <b>Kadaluarsa</b> dalam <?=$tgl_final; ?> hari <br/>
													Tanggal Kadaluarsa : <?=date('d/m/Y', strtotime($exp)); ?>
												</p>
											</div>
								...
								<?php elseif($tgl_final==0 && $data_row_ext->DOC_STATUS =="PUBLISH"): ?>
									...
									<?php elseif($arcived <= 30 && $arcived >= 1 && $data_row_ext->DOC_STATUS =="OBSOLETE"): ?>
										<div class="col-12">
											<div class="alert alert-block alert-warning">
												<p>Halo <?php echo $SESSION_ID; ?>!</p>
												<div class="row">
													...
													<div class="col-sm-2" style="width:4%;">
														<a data-toggle="modal" data-target="#modal-versioning<?=$data_row_ext->DOC_ID;?>" class="ace-icon fa fa-edit btn btn-sm btn-info" data-popup="tooltip" data-placement="top" title="Pengkinian"></a>
													</div>
													<div class="col-sm-2" style="width:4%;">
														<form id="form_comment[]" name="form_comment[]" action="<?php echo base_url('C_news/comment'); ?>" method="post" enctype="multipart/form-data">
															<input type="hidden" id="si_key[]" name="si_key[]" value="<?php echo $data_row_ext->DOC_ID; ?>" class="form-control" required/>
										...
										<?php elseif($arcived == 0 && $data_row_ext->DOC_STATUS =="OBSOLETE"): ?>
																		...
																		if($data_row->DOC_MAKER==$SESSION_ID){
																			...
																			<table width="100%">
																				<tr>
																					...
																					<th class="pull-right">
																						<a href="<?php echo base_url('C_menu/detail/'.$data_row->DOC_ID) ?>" class="fa fa-eye btn btn-link" style="font-size: 1.5rem;text-decoration: none;color: black;" target="_blank">Lihat</a>
																						<form id="form_comment[]" name="form_comment[]" action="<?php echo base_url('C_news/comment'); ?>" method="post" enctype="multipart/form-data">
							...
							<!-- End Modal Versioning -->
							<!-- Modal Versioning -->
							<?php 
							if($is_continue):
								foreach($get_data_ext as $data_row_ext):
									?>
									<div id="modal-versioning<?=$data_row_ext->DOC_ID;?>" class="modal" tabindex="-1">
													...
													<div class="row">
														<div class="col-sm-12">
															<div class="row">
																...
																<div class="col-sm-8">
																	<p><?php echo $data_row_ext->DOC_NOMOR; ?></p>
																</div>
															</div>
															<div class="row">
																<div class="col-sm-2" style="width:20%;">
																...
																<div class="col-sm-8">
																	<p><?php echo $data_row_ext->DOC_NAMA; ?></p>
																</div>
															</div>
															<div class="row">
																<div class="col-sm-2" style="width:20%;">
																...
																<div class="col-sm-2">
																	<div class="col-sm-9">
																		<input type="number" id="si_history_version2" name="si_history_version" placeholder="1.0" min="0" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==5) return false;" class="form-control" value="<?php echo $data_row_ext->DOC_VERSI; ?>" />
																	</div>
																	<div class="col-sm-2">
															...
															<div class="row">
																<div class="col-sm-12">
																	<form id="v_isi" class="v_isi" name="v_isi[]" action="<?php echo base_url('C_notification/versioning_isi'); ?>" method="post" enctype="multipart/form-data">
																		...
																		<br/>
																		<input type="hidden" id="si_key[]" name="si_key[]" value="<?php echo $data_row_ext->DOC_ID; ?>" class="form-control" required/>
																		<a href="<?=base_url('C_menu/zip/'.$data_row_ext->DOC_ID);?>" id="btn-unduh" class="btn-unduh btn btn-sm btn-warning">Unduh</a>
												...
												<div class="modal-body">
													<div class="row">
														...
														if ($EXT_UTAMA=="doc" || $EXT_UTAMA=="docx" || $EXT_UTAMA=="xls" || $EXT_UTAMA=="xlsx" || $EXT_UTAMA=="ppt" || $EXT_UTAMA=="pptx") {
															...
															// $url_path_utama = base_url('[file]/view.php?file='.$DOCD_UTAMA.'.pdf');
														}else{
														...
														if ($EXT_1=="doc" || $EXT_1=="docx" || $EXT_1=="xls" || $EXT_1=="xlsx" || $EXT_1=="ppt" || $EXT_1=="pptx") {
															...
															// $url_path_pelengkap_1 = base_url('[file]/view.php?file='.$DOCD_PELENGKAP_1.'.pdf');
														}else{
														...
														if ($EXT_2=="doc" || $EXT_2=="docx" || $EXT_2=="xls" || $EXT_2=="xlsx" || $EXT_2=="ppt" || $EXT_2=="pptx") {
															...
															// $url_path_pelengkap_2 = base_url('[file]/view.php?file='.$DOCD_PELENGKAP_2.'.pdf');
														}else{
														...
														<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
															<div class="row">
																...
																<div class="form-group">
																	...
																	<div class="col-sm-12">
																		<input type="text" class="form-control" value="<?=$data_row_ext->DOC_PERIODE_PREVIEW;?> BULAN" readonly>
																	</div>
																</div>
																<div class="form-group">
