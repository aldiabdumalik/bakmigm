										...
										?>
												<div class="profile-activity clearfix">
													<div>
														...
														<a class="user" href=""> <?php echo $data_row->DOC_MAKER; ?> </a>
														<div>
															<p>
																<table width="100%">
																	<tr>
																		...
																		<th class="pull-right">
																			<form id="form_view[]" name="form_view[]" action="<?php echo base_url('C_news/view'); ?>" method="post" enctype="multipart/form-data">
																				<input type="hidden" id="si_key[]" name="si_key[]" value="<?php echo $data_row->DOC_ID; ?>" class="form-control" required/>
																				<button type="submit" class="ace-icon fa fa-hand-o-right btn btn-sm btn-success"> View </button>
																			</form>
																		</th>
																	</tr>
																</table>
