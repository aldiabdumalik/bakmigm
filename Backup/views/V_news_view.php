					...
					?>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
							...
							<div class="form-group">
								<object data="<?=$url_path_utama;?>" type="application/pdf" width="500px" height="535px">
									<iframe src="<?=$url_path_utama;?>"></iframe>
								</object>
							</div>
							</div>
							<div class="col-md-1">
							<div class="form-group">
								...
								<textarea name="" id="" cols="70" rows="14"><?php echo $DOC_ABSTRAK; ?></textarea>
							</div>
							</div>
							</div>
							<div class="form-group">
								<a href="<?php echo $url_path_utama; ?>" target="_blank">Dokumen Utama</a><br/>
								<?php if($DOCD_PELENGKAP_1!="File_Not_Found"): ?>
								<a href="<?php echo $url_path_pelengkap_1; ?>" target="_blank">Dokumen Pelengkap 1</a><br/>
								<?php endif; ?>
								<?php if($DOCD_PELENGKAP_2!="File_Not_Found"): ?>
								<a href="<?php echo $url_path_pelengkap_2; ?>" target="_blank">Dokumen Pelengkap 2</a><br/>
								<?php endif; ?>
								<a href="<?php echo $url_path_persetujuan; ?>" target="_blank">Dokumen Persetujuan</a>
							</div>
									...
									<div class="panel-collapse collapse in" id="collapse_new_data">
										<div class="panel-body">
											...
											<form class="form-horizontal" id="form_new_data" name="form_new_data" action="<?php echo base_url('C_notification/comment_process'); ?>" method="post" enctype="multipart/form-data">
												...
												<input type="hidden" id="si_docid" name="si_docid" value="<?php echo $DOC_ID; ?>" class="form-control" required/>
												<input type="hidden" id="si_maker" name="si_maker" value="<?php echo $DOC_MAKER; ?>" class="form-control" required/>

												<div class="form-group">
													<label for="si_review" class="col-sm-4 control-label" style="text-align:left">Review</label>
													<div class="col-sm-8">
														<textarea type="text" name="si_review" id="si_review" rows="7" class="form-control" style="resize:none" required></textarea>
													</div>
												</div>
												
												<button type="submit" id="btn_comment" name="btn_comment" class="ace-icon fa fa-check btn btn-success btn-sm"></button>
											</form>
