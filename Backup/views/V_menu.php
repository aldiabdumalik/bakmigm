					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
							<div id="accordion" class="accordion-style1 panel-group">
								<form class="form-horizontal" id="form_search" name="form_search" action="<?php echo base_url('C_menu/cari'); ?>" method="POST">
								...
								<div class="panel panel-default">
									...
									<div class="panel-collapse collapse" id="collapse_advance_search">
										<div class="panel-body">
											<form class="form-horizontal" id="form_advance_search" name="form_advance_search" action="<?php echo base_url('C_menu/cari_advance'); ?>" method="post" enctype="multipart/form-data">
