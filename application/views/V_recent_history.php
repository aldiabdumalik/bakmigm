					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
							<div id="accordion" class="accordion-style1 panel-group">
								<form class="form-horizontal" id="form_search" name="form_search" action="<?php echo base_url('C_recent_history'); ?>" method="post" enctype="multipart/form-data">
									<div class="input-group">
										<span class="input-group-addon">
											<i class="ace-icon fa fa-check"></i>
										</span>
										<input type="text" id="ss_key_word" name="ss_key_word" class="form-control" placeholder="Search (Write A Keyword)" />
								...
								<div class="panel panel-default">
									...
									<div class="panel-collapse collapse" id="collapse_advance_search">
										<div class="panel-body">
											<form class="form-horizontal" id="form_advance_search" name="form_advance_search" action="<?php echo base_url('C_recent_history'); ?>" method="post" enctype="multipart/form-data">
								...
								<tr>
									...
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a class="blue" href="<?php echo base_url('C_menu'); ?>">
												<i class="ace-icon fa fa-eye bigger-130"></i>
											</a>
											<a class="green" href="<?php echo base_url('C_menu'); ?>">
										...
										<div class="hidden-md hidden-lg">
											<div class="inline pos-rel">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													<li>
														<a href="<?php echo base_url('C_menu'); ?>" class="tooltip-info" data-rel="tooltip" title="View">
															<span class="blue">
													...
													<li>
														<a href="<?php echo base_url('C_menu'); ?>" class="tooltip-success" data-rel="tooltip" title="Download">
															<span class="green">
