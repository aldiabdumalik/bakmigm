...
<table>
	<tr>
		...
		<td bgcolor="yellow">Penolak</td>
		<td bgcolor="yellow">Catatan</td>
		<td bgcolor="yellow">Tanggal</td>
	</tr>
	<?php for ($i=0; $i < $jumlah; $i++): ?>
	<?php $dokumen = $this->M_library_report->GET_DOCUMENT_REVISI($document[$i]); ?>
	...
	<tr>
		...
		<td><?= $dokumen->DTDLSS_MAKER; ?></td>
		<td><?= $dokumen->DTDLSS_NOTE; ?></td>
		<td><?= date('d/m/Y H:i', strtotime($dokumen->DTDLSS_DATE))." WIB"; ?></td>
	</tr>
	<?php endforeach; ?>
	<?php endif; ?>
	<?php endfor; ?>
