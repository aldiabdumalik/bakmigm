								...
								<div class="panel panel-default">
									...
									<div class="panel-collapse collapse in" id="collapse_new_data">
										<div class="panel-body">
											<!--
											<div class="col-12">
												<button type="submit" id="btn_get_data" name="btn_get_data" class="ace-icon fa fa-search pull-right btn btn-success btn-sm"></button>
											</div>
											<br /><br /><br />
											-->
											<form class="form-horizontal" id="form_new_data" name="form_new_data" action="<?php echo base_url('C_setting_user/insert'); ?>" method="post" enctype="multipart/form-data">
												<div class="form-group">
													<label for="si_userid" class="col-sm-4 control-label" style="text-align:left">Userid</label>
													<div class="col-sm-8">
														<input type="text" id="si_userid" name="si_userid" placeholder="Userid" class="form-control" required/>
													</div>
												</div>
												<div class="form-group">
													<label for="si_email" class="col-sm-4 control-label" style="text-align:left">Email</label>
													<div class="col-sm-8">
														<input type="email" id="si_email" name="si_email" placeholder="Email" class="form-control" required/>
													</div>
												</div>
												<div class="form-group">
													<label for="si_job_role" class="col-sm-4 control-label" style="text-align:left">Peran Tingkat Pekerjaan</label>
													<div class="col-sm-8">
														<select id="si_job_role" name="si_job_role" class="form-control" required>
															<option value="">Pilih</option>
															<?php
																$is_continue = true;
																$get_data_ext = $this->M_library_database->DB_GET_DATA_ROLES();
																if(empty($get_data_ext)||$get_data_ext==""){
																	$is_continue = false;
																}
																if($is_continue){
																	foreach($get_data_ext as $data_row_ext){
															?>
															<option value="<?php echo $data_row_ext->RS_ID; ?>"><?php echo $data_row_ext->RS_ID; ?></option>
															<?php
																	}
																}
															?>
												...
												<div class="form-group">
													<label for="duallistbox_departement" class="col-sm-4 control-label" style="text-align:left">Departemen</label>
													<div class="col-sm-8">
					...
					<div class="row">
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<?php
								$is_continue = true;
								$get_data = $this->M_library_database->DB_GET_DATA_USER_ARRAY();
								...
								<tr>
									...
									<td><?php echo $data_row->UR_EMAIL; ?></td>
									<td><?php echo $data_row->DN_CODE; ?></td>
									<td><?php echo $data_row->UR_DATE; ?></td>
									<td>Sinkronisasi Otomatis</td>
									
									<td>
										<form id="form_tool_table[]" name="form_tool_table[]" action="<?php echo base_url('C_setting_user/tool_table'); ?>" method="post" enctype="multipart/form-data">
											<input type="hidden" id="si_tool_table_key[]" name="si_tool_table_key[]" value="<?php echo $data_row->UR_ID; ?>" class="form-control" required/>
		...
		jQuery(function($) {
			...
			*/
			...
			$(document).one('ajaxloadstart.page', function(e) {
				...
				$('select[name="duallistbox_departement[]"]').bootstrapDualListbox('destroy');
				$('.rating').raty('destroy');
